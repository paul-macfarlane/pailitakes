...
- [ ] **CMT-3** — Comment tree UI (TanStack Query): nested render, indent to ~depth 5 then flatten with "replying to @name", mobile-first; optimistic insert on allow. _(deps: CMT-2)_
...
- [ ] **CMT-8** — Admin: delete any comment; lock comments on a post. _(deps: CMT-3, ADM-1)_
...
- [ ] **CMT-10** — Enforce ban at the comment action level. _(deps: CMT-4)_
