...
- [~] **FND-6** — Vercel project; staging + prod environments; Neon `staging`/`main` branches; per-env OAuth clients with registered redirect URIs. _(deps: FND-4)_ — Vercel project created, linked, and connected to the GitHub repo; remaining steps need account/console access (Neon, OAuth, DNS, secrets): see `docs/runbooks/environments.md`.
