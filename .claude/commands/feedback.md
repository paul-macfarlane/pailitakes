...
2. **Scout** — dispatch parallel Explore agents to gather the facts the plan needs (current call sites, duplication maps, coverage inventories). Don't plan from memory.
