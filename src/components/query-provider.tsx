...
// deliberately uncached (design §3) — comments, and (ANLY-5) the admin
// analytics dashboard, whose range/granularity controls need client-side
// refetching against an uncached admin API route. A new consumer should be
// able to justify the same tradeoff before reaching for this provider
