// Paulitakes logo mark, mirroring src/app/icon.svg (BRAND-2/BRAND-4): blocky
// chamfered P with a layered flame filling the bowl. Raw hexes are the
// brand-asset exception to the theme-token rule (ADR-0024): the mark must
// render identically in both themes and stay in sync with icon.svg.
